    ...
    <div className="relative overflow-x-auto rounded-lg border border-gray-200 bg-white">
      <table className="w-full border-collapse text-left text-sm min-w-4xl">
        <thead className="border-gray-200 border-b hover:bg-gray-100 transition-all duration-200">
          <tr>
            <th className="px-4 py-2 font-normal text-gray-500 text-sm w-[12%]">
              Transaction #
            </th>
            <th className="px-4 py-2 font-normal text-gray-500 text-sm w-[12%]">
              Submitted Date
            </th>
            <th className="px-4 py-2 font-normal text-gray-500 text-sm w-[11%]">
              Type
            </th>
            <th className="px-4 py-2 font-normal text-gray-500 text-sm w-[15%]">
              Customer
            </th>
            <th className="px-4 py-2 font-normal text-gray-500 text-sm w-[11%]">
              Title
            ...
            <th className="px-4 py-2 text-right text-gray-500 text-sm w-[6%]">
              Actions
            </th>
          </tr>
        </thead>
