    ...
    <div className="container mx-auto p-6 overflow-auto">
      ...
      <div className="space-y-6 pb-6">
        ...
        <div className="rounded-xl border border-gray-200 p-6 shadow-sm">
          ...
          <div className="p-6 pt-0">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Detail label="End User" value={salesLead.endUser} />
              <Detail label="Designation" value={salesLead.designation} />
              <Detail label="Department" value={salesLead.department} />
              <Detail label="Immediate Support" value={salesLead.immediateSupport} />
              <Detail label="Contact Number" value={salesLead.contactNo} />
        ...
        <div className="rounded-xl border border-gray-200 p-6 shadow-sm">
          ...
          <div className="p-6 pt-0">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Detail label="Machine Process" value={salesLead.machineProcess} />
              <Detail label="Needed Product" value={salesLead.neededProduct} />
              <Detail label="Existing Specifications" value={salesLead.existingSpecifications} />
            </div>
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              <Detail label="Issues with Existing" value={salesLead.issuesWithExisting} />
        ...
        <div className="rounded-xl border border-gray-200 p-6 shadow-sm">
          ...
          <div className="p-6 pt-0">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Detail label="Quantity Attention" value={salesLead.quantityAttention} />
              <Detail label="QR CC" value={salesLead.qrCc} />
              <Detail label="QR Email To" value={salesLead.qrEmailTo} />
              <Detail label="Next Follow-up Date" value={salesLead.nextFollowupDate} />
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-gray-200 p-6 shadow-sm">
          ...
          <div className="p-6 pt-0">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <Detail label="Account" value={salesLead.account} />
              <Detail label="Sales Engineer" value={salesLead.seUsername || salesLead.seId} />
              <Detail label="Date" value={salesLead.fslDate} />
              <Detail label="Time" value={salesLead.fslTime} />
              <Detail label="Location" value={salesLead.fslLocation} />
              <Detail label="PO Ref" value={salesLead.fslRef} />
              <Detail label="Concept" value={salesLead.requirement} />
              <Detail label="Objective" value={salesLead.requirementCategory} />
              <Detail label="Deadline" value={salesLead.deadline} />
            </div>
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              <Detail label="Existing Setup and Items" value={salesLead.existingSetupItems} />
              <Detail label="Recommended Model/Composition" value={salesLead.customerSuggestedSetup} />
            </div>
            <div className="mt-4">
              <Detail label="Remarks/Additional Information" value={salesLead.remarks} />
            </div>
          </div>
        </div>
      </div>
