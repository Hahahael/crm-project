...
export default function VendorSelectionModal({
  ...
  const filteredVendors = allVendors.filter((vendor) => {
    ...
    const name = (vendor.Name || vendor.name || vendor.Code || "")
      .toString()
      .toLowerCase();
    const contact = (vendor.details?.Name || vendor.contactPerson || "")
      .toString()
      .toLowerCase();
    const email = (vendor.details?.EmailAddress || vendor.email || "")
      .toString()
      .toLowerCase();
      ...
      >
        ...
        <div className="flex flex-col space-y-1.5 text-center sm:text-left">
          ...
          <p className="text-sm text-gray-500">
            Choose vendors to send this RFQ request. You can select multiple
              ...
              <div
                ...
                className={`p-4 transition-colors cursor-pointer ${
                  selectedVendors.some(
                    (v) => (v.Id ?? v.id) === (vendor.Id ?? vendor.id),
                  )
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="font-medium text-gray-900">
                        {vendor.Name || vendor.name || vendor.Code || "-"}
                      </h4>
                    </div>
                    <div className="space-y-1 text-sm text-gray-500">
                      <div className="flex items-center space-x-2">
                        ...
                        <span>
                          {vendor.details?.Name || vendor.contactPerson || "-"}
                        </span>
                      </div>
                      <div className="flex items-center space-x-2">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span>
                          {vendor.details?.EmailAddress || vendor.email || "-"}
                        </span>
                      </div>
        ...
        <div className="flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 mt-4">
          ...
          >
            Select {selectedVendors.length} Vendor
